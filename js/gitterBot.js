...
function dataFormatter(name, uname, role, id, urlmedium) {
    var temp_html = '<div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">';
        ...
        temp_html += '<a href="https://www.github.com/' + uname + '" target="_blank"><span class="profile_link">View GitHub Profile</span></a>';
        temp_html += '</button>';
